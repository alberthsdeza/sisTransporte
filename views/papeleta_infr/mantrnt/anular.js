        ...
        if (result.isConfirmed) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "../../../controller/rnt.php?op=anular_rnt",
                        method: "POST",
                        data: {
                            identificador: id_,
                            pers_id: usua_id,
                        ...
                        success: function (data) {
                            ...
                            if (response.status === 'success') {
                                Swal.fire({
                                    icon: "success",
                                    title: "Exitoso!",
                                    text: `El rnt código: ${codigo} se anuló correctamente.`,
                        ...
                        error: function (jqXHR, textStatus, errorThrown) {
                            Swal.fire({
                                ...
                                text: "Hubo un problema al intentar anular el código del rnt. Por favor, inténtelo nuevamente más tarde.",
                                showConfirmButton: true,
                            });
